...
namespace WPFOpenGLLib 
{
		...
		virtual HandleRef BuildWindowCore(HandleRef hwndParent) override 
		{
			...
			if(RegisterWindowClass())
			{
				...
				if(m_hDC && m_hWnd)
				{
					...
					GameWorld::getInstance().Volkes = (EXTERN::VolkesIterface*)instance;
	...
	public :
		void SetNewPiece(String^ sprite)
		{
			...
			{
				GameWorld::getInstance().setNewPiece(ssprite);
			}
			else
			{
				...
				{
					GameWorld::getInstance().setNewImageControl(ssprite);
				}
				else
				{
					GameWorld::getInstance().setNewImageControl(LogicCommon::UIObjectTreeContator::GetInstance()->root,ssprite);
				}
			}
		...
		void SetNewPiece(String^ ModelName, String ^ TextureName)
		{
			...
			GameWorld::getInstance().setNewPiece(sModelname,sTextureName);
		...
		void SetNewPiece(float Width, float Height, String ^ TextureName)
		{
			...
			GameWorld::getInstance().setNewPiece(Width,Height,sTextureName);
		...
		void SetNewPiece(float Width, float Height, String ^ TextureName,String ^ TextureAlpha)
		{
			...
			{
				GameWorld::getInstance().setNewPiece(Width, Height, sTextureName, sTextureAlpha);
			}
			else
			{
				GameWorld::getInstance().setNewPiece(LogicCommon::SelectObjectInterface::GetInstance()->root,Width, Height, sTextureName, sTextureAlpha);
			}
