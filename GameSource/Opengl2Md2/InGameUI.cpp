...
namespace GameEngine
{
	...
	{
		//GameWorld::getInstance().Load("E:\\Monstone\\NewProject\\Stage1.xml");
		...
		GameWorld::getInstance().child.push_back(king);
		ObjectManager* m_ObjectManager = ObjectManager::GetInstance();
		m_ObjectManager->ReplaceGameObejct("KingPlayer", king);
		/////////////////////////
