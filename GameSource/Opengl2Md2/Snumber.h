...
namespace GameEngine
{
	...
	class DllExport Snumber : public ImageControl
	{
	...
	private:
		int NumberSizeCommaWidth ;

	private:
		int NumberActureSize ;
	...
	public:
		Snumber()
		{
			...
			{
				char buff[101];
				snprintf(buff, sizeof(buff), "minipacmen%02d", i);
				std::string buffAsStdStr = buff;
