...
class DllExport Texture2DManager :
...
public:
	...
	{
		string AbsoluteFileName = GameWorld::getInstance()._RootDirctory + "\\asset\\" + filename;
	...
	{
		string AbsoluteFileName = GameWorld::getInstance()._RootDirctory + "\\asset\\" + filename;
		string AlphaAbsoluteFileName = GameWorld::getInstance()._RootDirctory + "\\asset\\" + Alphafilename;
